# Binomial & Poisson distributions {#bin_pois}
...
*Q35. Copy down the binomial probability mass function (from \@ref(appendix)) and use it as an alternative method for calculating the fertility proportions for two eggs (as per the quadratic equation approach).*
